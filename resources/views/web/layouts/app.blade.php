                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 align-center-vertical">
                            <a href="{{ route('web.home.index') }}">
                                <img class="logo-img d-inline" src="{{ asset('assets/imgs/logo-2.png') }}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-lg-6">
                                <div class="footer-copy-right">
                                    <p class="font-medium">© 2024 - 2025, UltraNews | Toàn bộ nội dung | Thiết kế bởi <a href="{{ route('web.home.index') }}" target="_blank">Quản Trị Viên</a></p>
                                </div>
                            </div>
                            <div class="col-lg-6">
